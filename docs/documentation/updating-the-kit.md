...
```
origin  https://github.com/johndoe/nhs-prototyping-kit.git (fetch)
origin  https://github.com/johndoe/nhs-prototyping-kit.git (push)
```

So long as you can see a list of repositories as above, we can move on to adding a reference to the original 'nhsleadership' repository which we will need in order to update.
...
```
git remote add upstream https://github.com/NHSLeadership/nhs-prototyping-kit.git
```
...
```
origin	https://github.com/NHSLeadership/nhs-prototyping-kit.git (fetch)
origin	https://github.com/NHSLeadership/nhs-prototyping-kit.git (push)
upstream	https://github.com/NHSLeadership/nhs-prototyping-kit.git (fetch)
upstream	https://github.com/NHSLeadership/nhs-prototyping-kit.git (push)
```
...
```
From https://github.com/NHSLeadership/nhs-prototyping-kit
...
If you still have an error, you can [raise an issue within github](https://github.com/NHSLeadership/nhs-prototyping-kit/issues) providing as much information as you can about the error and the computer you are attempting to run the prototyping kit on.
